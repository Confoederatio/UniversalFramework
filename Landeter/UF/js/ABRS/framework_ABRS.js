...
*/
global.changeSaveDirectory = function (arg0_path) {
...
*/
global.cleanCorruptFiles = function (arg0_options) {
  //Convert from parameters
...
*/
global.cleanEmptyFiles = function (arg0_options) {
  //Convert from parameters
  var options = (arg0_options) ? arg0_options : {};
...
/*
  ...
  arg0_options: (Object)
    log: (Boolean) - Optional. Whether to log the backup array. True by default.
*/
global.cleanInvalidJSONFiles = function (arg0_options) {
  //Convert from parameters
  var options = (arg0_options) ? arg0_options : {};
...
/*
  ...
  Returns: (String)
*/
global.cleanEscapeStrings = function (arg0_string) {
  //Convert from parameters
...
/*
  ...
  arg0_options: (Object)
    log: (Boolean) - Optional. Whether to log the backup array. True by default.
*/
global.loadBackupArray = function (arg0_options) {
  //Convert from parameters
  var options = (arg0_options) ? arg0_options : {};
...
*/
global.loadMostRecentSave = function (arg0_options) {
  //Convert from parameters
  var options = (arg0_options) ? arg0_options : {};
...
global.loadRequirements = function () {
...
*/
global.loadSave = function (arg0_file, arg1_options) {
  //Convert from parameters
...
/*
  ...
  Returns: (String)
*/
global.returnABRSDateString = function () {
  //Declare local instance Variables
  var d = new Date();
...
/*
  ...
  arg0_options: (Object)
    log: (Boolean) -  Optional. Whether to log the backup array. True by default.
*/
global.writeDB = function (arg0_file, arg1_options) {
  //Convert from parameters
...
*/
global.writeSave = function (arg0_options) {
  //Convert from parameters
  var options = (arg0_options) ? arg0_options : {};
